...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info("numericalcolumns standard scaling done")
            logging.info("Categoricalcolumns encoding & standard scaling done")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("getting preprocessing object and applying on test and train df")
